...
$sql1 = "select * from sales_invoice where id = '$id'";
...
//    $sqlUpdateCustomer  = "UPDATE `customer` SET `name`='$name',`user_name`='$user_name',`shop_name`='$shop_name',`phone_number`='$phone_number',`address`='$address',`dob`='$dob',`nrc`='$nrc',`town`='$town_ship' WHERE id='$customer_id'";
